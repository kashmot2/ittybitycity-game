...
const MAP_URL = 'https://functions-weblog-listening-covered.trycloudflare.com/map-draco.glb';

/** URL for the animated character model */
const CHARACTER_URL = 'https://functions-weblog-listening-covered.trycloudflare.com/character.glb';
